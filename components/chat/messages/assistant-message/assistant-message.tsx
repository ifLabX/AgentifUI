          ...
          return (
            <a
              ...
              className={cn(
                ...
                'border-gray-300 bg-gray-50 text-sky-600 hover:border-gray-400 hover:text-sky-700 dark:border-gray-600 dark:bg-gray-800 dark:text-sky-400 dark:hover:border-gray-500 dark:hover:text-sky-300'
              )}
              target="_blank"
