...
export function MessageSkeleton() {
  return (
    <div className="relative flex w-full animate-pulse flex-col gap-8 px-4 py-6 bg-gradient-to-b from-stone-100 to-stone-100/30 dark:from-stone-900 dark:to-stone-900/30">
      ...
      <div className="flex justify-start">
        <div
          className={cn(
            ...
            'bg-white shadow-sm dark:border dark:border-stone-700 dark:bg-stone-900'
          )}
        >
